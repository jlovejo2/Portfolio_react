            ...
            <div className="card-body">
              <div className="row text-wrap">
                ...
                <div className="col-lg-8 col-md-12">
                  <p>
                    My name is James Lovejoy and I am an aspiring web developer.
                    I graudated from the NorthWestern Webdevelopment Coding
                    bootcamp in April and haven't stopped learning since. I find
                    coding to be a great outlet and way to solve problems
                    everday. To quote the great Vanilla Ice
                    <a
                  ...
                  <p>
                    ...
                    wilderness therapy company in the deserts of Oregon (if you
                    don't belive me that Oregon has deserts, i'd love to tell
                    you about them!), and a short stint at a brewing company
                    while I learned to code. There's a lot of science and
                    problem solving in the making of beer too!
                  </p>
                </div>
                <div className="col-12 mt-2">
                  <p>
                    Whether its working in a team or on my own I am your guy. I
                    have the due deligience and work ethic to stay motivated and
                    on schedule by myself. However, the communication skills I
                    have developed and honed with my diverse background give me
                    the ability to adapt to any team setting and fill in the
                    gaps.
                  </p>
                </div>
              </div>
